...
import { Card, Table, Button, Input, Modal, Form, Space, Typography, Tag } from '@douyinfe/semi-ui';
...
function Subordinates() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'quota',
      render: (quota) => {
        return <Text>{(quota / 500000).toFixed(2)} 元</Text>;
      }
    },
    {
      title: '已用额度',
      ...
      render: (used_quota) => {
        return <Text>{(used_quota / 500000).toFixed(2)} 元</Text>;
      }
    },
    {
      title: '状态',
    ...
    },
    {
      ...
      width: 200,
      render: (note) => {
        return <Text ellipsis={{ showTooltip: true }}>{note || '-'}</Text>;
      }
    },
    {
      title: '操作',
